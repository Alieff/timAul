...
<meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <script src="../timAul/web/node_modules/chart.js/dist/Chart.js"></script>
    <script src="../timAul/web/node_modules/chart.js/dist/Chart.min.js"></script>
    <title>Admin Inspire Crawler</title>
    <link rel="stylesheet" href="../timAul/web/resources/assets/css/templateInspire.css">
    ...
    <link href="../timAul/web/resources/assets/css/admin.css" rel="stylesheet">


    <!-- Morris Charts CSS -->
    <link href="../timAul/web/resources/assets/bower_components/morrisjs/morris.css" rel="stylesheet">

    <!-- jQuery -->
    <script src="../timAul/web/resources/assets/bower_components/jquery/dist/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="../timAul/web/resources/assets/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="../timAul/web/resources/assets/bower_components/metisMenu/dist/metisMenu.min.js"></script>

    <!-- Morris Charts JavaScript -->
    <script src="../timAul/web/resources/assets/bower_components/raphael/raphael-min.js"></script>
    <!--script src="../../resources/assets/bower_components/morrisjs/morris.min.js"></script-->
    <script src="../timAul/web/resources/assets/js/morris-data.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="../timAul/web/resources/assets/js/sb-admin-2.js"></script>
