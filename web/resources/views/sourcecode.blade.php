	...
	<div id="page-content-wrapper">
	  <!--img style="width:100%" src="..\resources\assets\images\landing.jpg" class="img-responsive" alt="Responsive image"-->
		<div class="col-lg-12" style="text-align: left;padding-left: 20px;padding-right: 20px">
			...
			<p>
			Untuk <i> source code</i> juga dokumentasinya, dapat dilihat dengan klik tombol <strong> Source Code </strong> dibawah ini atau dokumentasi javadoc pada tombol <strong> Javadoc </strong>.
			</p>
			...
			<div class="row" style="padding-top: 25px">
				...
				<div class="col-md-3 col-md-offset-1 btn-lg col-xs-4 col-xs-offset-2"><a href="javadocs" class="btn btn-primary">JAVADOC</a></div> 
			</div>
		</div>
	</div>
</div>
